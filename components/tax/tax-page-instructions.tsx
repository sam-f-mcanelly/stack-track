            ...
            <AccordionContent>
              <div className="space-y-6 text-sm">
                ...
                <div className="p-3 bg-slate-50 dark:bg-slate-800/60 rounded-lg">
                  <p>
                    This tool helps you generate tax reports by matching sell transactions with
                    their corresponding buy transactions using different accounting methods. Follow
                    the steps below to prepare your cryptocurrency tax report.
                  </p>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="ml-2 space-y-3">
                    <div className="flex">
                      <div className="flex-shrink-0 flex items-center justify-center w-6 h-6 rounded-full bg-green-100 dark:bg-green-900/60 text-green-700 dark:text-green-400 text-xs font-bold mr-3">
                        1
                      </div>
                      <div>
                        <p className="font-medium">Select transactions to report</p>
                        <p className="text-slate-600 dark:text-slate-400 mt-1">
                          Check the boxes next to the sell transactions you want to include in your
                          tax report.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex">
                      ...
                      <div>
                        ...
                        <p className="text-slate-600 dark:text-slate-400 mt-1">
                          Select FIFO, LIFO, or CUSTOM from the dropdown for each transaction.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex">
                      ...
                      <div>
                        ...
                        <p className="text-slate-600 dark:text-slate-400 mt-1">
                          If using CUSTOM method, click Configure to select specific buy
                          transactions.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex">
                      ...
                      <div>
                        ...
                        <p className="text-slate-600 dark:text-slate-400 mt-1">
                          Click the "Generate Report" button to calculate gains/losses and create
                          your report.
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="mt-3 grid grid-cols-1 md:grid-cols-3 gap-3">
                    <div className="p-3 bg-white dark:bg-slate-800 border dark:border-slate-700 rounded-lg">
                      <div className="flex items-center mb-2">
                        ...
                        <TooltipProvider delayDuration={300}>
                          <Tooltip>
                            ...
                            <TooltipContent>
                              <p className="w-[200px]">
                                First In, First Out - Oldest purchases are used first. Often results
                                in lower taxes if asset has appreciated over time.
                              </p>
                            </TooltipContent>
                          </Tooltip>
                        </TooltipProvider>
                      ...
                      <p className="text-slate-600 dark:text-slate-400 text-xs">
                        Oldest buy transactions are used first. Typically results in more long-term
                        gains.
                      </p>
                    </div>
                    ...
                    <div className="p-3 bg-white dark:bg-slate-800 border dark:border-slate-700 rounded-lg">
                      <div className="flex items-center mb-2">
                        ...
                        <TooltipProvider delayDuration={300}>
                          <Tooltip>
                            ...
                            <TooltipContent>
                              <p className="w-[200px]">
                                Last In, First Out - Newest purchases are used first. May result in
                      ...
                      <p className="text-slate-600 dark:text-slate-400 text-xs">
                        Newest buy transactions are used first. May minimize gains during market
                        downturns.
                      </p>
                    </div>
                    ...
                    <div className="p-3 bg-white dark:bg-slate-800 border dark:border-slate-700 rounded-lg">
                      <div className="flex items-center mb-2">
                        ...
                        <TooltipProvider delayDuration={300}>
                          <Tooltip>
                            ...
                            <TooltipContent>
                              <p className="w-[200px]">
                                Custom selection lets you manually choose which buy transactions to
                                match with each sell.
                              </p>
                            </TooltipContent>
                          </Tooltip>
                        </TooltipProvider>
                      ...
                      <p className="text-slate-600 dark:text-slate-400 text-xs">
                        Manually select buy transactions. Offers most control over tax optimization.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <ul className="mt-1 text-orange-800 dark:text-orange-300 space-y-1 list-disc pl-4">
                        <li>
                          If you don't have enough buy transactions to cover a sell, the uncovered
                          portion will be treated as having a $0 cost basis.
                        </li>
                        <li>
                          Assets held for more than one year qualify for long-term capital gains
                          rates.
                        </li>
                        <li>
                          This report is for informational purposes. Consult a tax professional for
                          advice.
                        </li>
                      </ul>
                    </div>
